                                ...
                                <div className="container mx-auto px-5 lg:px-35 flex justify-center relative py-8">
                                    <div className="gap-4 sm:w-2/3 lg:w-2/5 flex items-center justify-center lg:items-start flex-col relative z-20  lg:mx-4 bg-cover bg-center" style={{ backgroundImage: `url(${baground1})` }}>
                                        ...
                                        <div className="flex mt-8">
                                            <a href="#" className="uppercase py-2 px-4 rounded-lg bg-green-600 border-2 border-transparent text-white text-md mr-4 hover:bg-green-700 hover:text-white">
                                                Get started
                                            </a>
                                            <a href="#" className="uppercase py-2 px-4 rounded-lg bg-transparent border-2 border-green-600 text-green-600 hover:bg-green-700 hover:text-white text-md">
                                                Read more
                                            </a>
                                        </div>
                                    </div>
